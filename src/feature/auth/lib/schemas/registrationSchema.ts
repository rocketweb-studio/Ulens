...
export const registrationSchema = z.object({
    userName: z.string().trim().min(6, {error: 'Minimum number of characters 6'}).max(30, {error: 'Maximum number of characters 30'}).regex(/^[0-9A-Za-z\_-]+$/, {error:'Username must contain 0-9, A-Z, a-z, _, -'}),
