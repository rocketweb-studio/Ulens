...
import { passwordSchema } from '@/src/entities/auth/model/schemas/passwordSchema'
      ...
      {!isValidCode && (
        <div className={s.pageWrapper}>
          ...
          : <>
              ...
              <ReCaptcha setCaptcha={setCaptcha} recaptchaToken={process.env.NEXT_PUBLIC_RECAPTCHA_TOKEN!} />
            </>
          }
